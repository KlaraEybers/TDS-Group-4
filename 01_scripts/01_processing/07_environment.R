...
env_clean <- selected_data %>%
  mutate(
    # ----------------------------------------------------------
    # Air quality variables: Cap the implausible variables for these 3
    # ----------------------------------------------------------
    ...
    # ----------------------------------------------------------
    # Home area population density - 3 Categories now (Urban/Town/Rural), (Postcode not linkable -> NA)
    # ----------------------------------------------------------
